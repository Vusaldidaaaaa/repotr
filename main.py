...
def is_word_answered(update, context):
    ...
    if game.is_word_answered(user_id, text):
        update.message.reply_text('*{}* rəqəmini [{}](tg://user?id={}) tapdı. 👨🏻‍🎓Artıq o yeni Müəlliminizdir'.format(word, username,user_id), reply_to_message_id=True, parse_mode=ParseMode.MARKDOWN)
